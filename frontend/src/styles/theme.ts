...
export const theme = createTheme({
  ...
  typography: {
    ...
    h4: { fontFamily: '"DM Sans", "Inter", sans-serif', fontSize: "1.5rem", fontWeight: 700, lineHeight: 1.35, letterSpacing: "-0.02em" },
    h5: { fontFamily: '"DM Sans", "Inter", sans-serif', fontSize: "1.125rem", fontWeight: 600, lineHeight: 1.4, letterSpacing: "-0.01em" },
    h6: { fontFamily: '"DM Sans", "Inter", sans-serif', fontSize: "1rem", fontWeight: 600, lineHeight: 1.5 },
